...
// Написать программу, которая считывает значение из prompt и выводит один из фраз “Это значение можно преобразовать в число” или “Это значение преобразовать в число не получится. Получится NaN”.
